...
--
-- Host: localhost    Database: hspc_8_MasterDstu2Empty
-- ------------------------------------------------------
...
CREATE TABLE `HFJ_FORCED_ID` (
  `PID` bigint(20) NOT NULL,
  `FORCED_ID` varchar(100) CHARACTER SET latin1 NOT NULL,
  `RESOURCE_PID` bigint(20) NOT NULL,
  `RESOURCE_TYPE` varchar(100) CHARACTER SET latin1 DEFAULT '',
  PRIMARY KEY (`PID`),
...
CREATE TABLE `HFJ_HISTORY_TAG` (
  ...
  `RES_TYPE` varchar(40) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `HFJ_IDX_CMP_STRING_UNIQ` (
  `PID` bigint(20) NOT NULL,
  `IDX_STRING` varchar(200) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `HFJ_RESOURCE` (
  ...
  `RES_VERSION` varchar(7) CHARACTER SET latin1 DEFAULT NULL,
  `HAS_TAGS` bit(1) NOT NULL,
  `RES_PUBLISHED` datetime NOT NULL,
  `RES_UPDATED` datetime NOT NULL,
  `SP_HAS_LINKS` bit(1) DEFAULT NULL,
  `HASH_SHA256` varchar(64) CHARACTER SET latin1 DEFAULT NULL,
  `SP_INDEX_STATUS` bigint(20) DEFAULT NULL,
  `RES_LANGUAGE` varchar(20) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `RES_PROFILE` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
  `RES_TYPE` varchar(40) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `HFJ_RES_LINK` (
  `PID` bigint(20) NOT NULL,
  `SRC_PATH` varchar(200) CHARACTER SET latin1 NOT NULL,
  `SRC_RESOURCE_ID` bigint(20) NOT NULL,
  `SOURCE_RESOURCE_TYPE` varchar(40) CHARACTER SET latin1 NOT NULL,
  `TARGET_RESOURCE_ID` bigint(20) DEFAULT NULL,
  `TARGET_RESOURCE_TYPE` varchar(40) CHARACTER SET latin1 NOT NULL,
  `TARGET_RESOURCE_URL` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `HFJ_RES_VER` (
  `PID` bigint(20) NOT NULL,
  `RES_DELETED_AT` datetime DEFAULT NULL,
  `RES_ENCODING` varchar(5) CHARACTER SET latin1 NOT NULL,
  `RES_VERSION` varchar(7) CHARACTER SET latin1 DEFAULT NULL,
  `HAS_TAGS` bit(1) NOT NULL,
  `RES_PUBLISHED` datetime NOT NULL,
  `RES_TEXT` longblob,
...
CREATE TABLE `HFJ_SEARCH` (
  ...
  `FAILURE_MESSAGE` varchar(500) CHARACTER SET latin1 DEFAULT NULL,
  ...
  `RESOURCE_TYPE` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
  `SEARCH_QUERY_STRING` longtext CHARACTER SET latin1,
  `SEARCH_QUERY_STRING_HASH` int(11) DEFAULT NULL,
  `SEARCH_TYPE` int(11) NOT NULL,
  `SEARCH_STATUS` varchar(10) CHARACTER SET latin1 NOT NULL,
  `TOTAL_COUNT` int(11) DEFAULT NULL,
  `SEARCH_UUID` varchar(36) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `HFJ_SEARCH_INCLUDE` (
  `PID` bigint(20) NOT NULL,
  `SEARCH_INCLUDE` varchar(200) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `HFJ_SPIDX_COORDS` (
  ...
  `SP_NAME` varchar(100) CHARACTER SET latin1 NOT NULL,
  `RES_ID` bigint(20) NOT NULL,
  `RES_TYPE` varchar(100) CHARACTER SET latin1 NOT NULL,
  `SP_UPDATED` datetime DEFAULT NULL,
...
CREATE TABLE `HFJ_SPIDX_QUANTITY` (
  ...
  `RES_TYPE` varchar(100) CHARACTER SET latin1 NOT NULL,
  `SP_UPDATED` datetime DEFAULT NULL,
  `SP_SYSTEM` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
  `SP_UNITS` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
  `SP_VALUE` decimal(19,2) DEFAULT NULL,
  `HASH_IDENTITY` bigint(20) DEFAULT NULL,
...
CREATE TABLE `HFJ_SPIDX_STRING` (
  ...
  `RES_TYPE` varchar(100) CHARACTER SET latin1 NOT NULL,
  `SP_UPDATED` datetime DEFAULT NULL,
  `SP_VALUE_EXACT` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
  `SP_VALUE_NORMALIZED` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `HFJ_SPIDX_TOKEN` (
  ...
  `SP_UPDATED` datetime DEFAULT NULL,
  `SP_SYSTEM` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
  `SP_VALUE` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `HFJ_SPIDX_URI` (
  ...
  `RES_TYPE` varchar(100) CHARACTER SET latin1 NOT NULL,
  `SP_UPDATED` datetime DEFAULT NULL,
  `SP_URI` varchar(254) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `TRM_CODESYSTEM` (
  `PID` bigint(20) NOT NULL,
  `CODE_SYSTEM_URI` varchar(200) CHARACTER SET latin1 NOT NULL,
  `RES_ID` bigint(20) DEFAULT NULL,
  `CURRENT_VERSION_PID` bigint(20) DEFAULT NULL,
  `CS_NAME` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`PID`),
...
CREATE TABLE `TRM_CODESYSTEM_VER` (
  ...
  `RES_ID` bigint(20) NOT NULL,
  `CS_VERSION_ID` varchar(200) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `TRM_CONCEPT` (
  `PID` bigint(20) NOT NULL,
  `CODEVAL` varchar(500) CHARACTER SET latin1 NOT NULL,
  `CODESYSTEM_PID` bigint(20) DEFAULT NULL,
  `DISPLAY` varchar(400) CHARACTER SET latin1 DEFAULT NULL,
  `INDEX_STATUS` bigint(20) DEFAULT NULL,
  `CODE_SEQUENCE` int(11) DEFAULT NULL,
  `PARENT_PIDS` longtext CHARACTER SET latin1,
...
CREATE TABLE `TRM_CONCEPT_PROPERTY` (
  `PID` bigint(20) NOT NULL,
  `PROP_KEY` varchar(500) CHARACTER SET latin1 NOT NULL,
  `PROP_VAL` varchar(500) CHARACTER SET latin1 DEFAULT NULL,
  `CONCEPT_PID` bigint(20) DEFAULT NULL,
  `PROP_CODESYSTEM` varchar(500) CHARACTER SET latin1 DEFAULT NULL,
  `PROP_DISPLAY` varchar(500) CHARACTER SET latin1 DEFAULT NULL,
...
-- Dump completed on 2020-11-13 15:38:51
