...
4. Download and run the mysql instance. This will download the database image containing template schemas.
    ...
    ```
5. Confirm that the database schemas are part of the pre-populated database image (optional step). Run the following command to go to the bash prompt of the MySQL container. 
   ```sh
